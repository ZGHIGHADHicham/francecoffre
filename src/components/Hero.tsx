    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 md:px-8 pt-32 pb-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* CTA Buttons */}
          <div 
            className="flex flex-col sm:flex-row gap-4 justify-center mb-12 opacity-0 animate-fade-up"
          ...
          {/* Features strip - Only this part is in a card */}
          <div 
            className="bg-white/85 backdrop-blur-sm rounded-2xl px-8 py-6 shadow-lg opacity-0 animate-fade-up"
